...
exports.MOCK_RFQS = exports.MOCK_USERS = void 0;
exports.MOCK_USERS = [
    {
        id: '1',
...
exports.MOCK_RFQS = [
    ...
    },
    {
        ...
        inquiryTime: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(),
        creatorId: '2',
        assignedPurchaserIds: ['3'],
        customerType: 'New',
        ...
        products: [
            {
                id: 'prod-003',
                wlid: 'FTCP0001',
                productSeries: 'Topper',
                sku: 'TP-789',
                hairFiber: 'Human Hair',
                cap: 'Mono Top',
                capSize: 'Small',
                length: '12 inches',
                density: '130%',
                color: 'Dark Brown',
                curlStyle: 'Natural Straight',
                images: [],
                imagePreviews: [],
            },
        ],
